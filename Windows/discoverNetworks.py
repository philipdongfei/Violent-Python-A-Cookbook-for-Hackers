...
def wiglePrint(username, password, netid):
    browser = mechanize.Brower()
    brower.open('http://wigle.net')
    reqData = urllib.urlencode({'credential_0': username,
        'credential_1': password})
    brower.open('https://wigle.net/gps/gps/main/login', reqData)
    params = {}
    params['netid'] = netid
...
def printNets(username, password):
    net = b"SOFTWARE\Microsoft\Windows NT\CurrentVersion"+\
            b"\NetworkList\Signatures\Unmanaged"
